...
ok("versionCode 15" in app_gradle, 'versionCode must be 15')
ok("versionName '2.4-selectable-ocr-lines'" in app_gradle, 'versionName mismatch')
...
ok('apps-v2/long-ocr-v13.apk' in catalog, 'default Long OCR 1.3 APK URL missing')
...
ok("versionName '1.3-selectable-lines'" in (root/'longocr/build.gradle').read_text(), 'Long OCR version mismatch')
ok('getBoundingBox' in ocr_main and 'thenComparingInt' in ocr_main,
   'Long OCR coordinate line sorting missing')
ok('Đã nhận " + rowCount + " hàng' in ocr_main, 'Long OCR selectable text rows missing')
...
print('Version: 2.4-selectable-ocr-lines (15)')
