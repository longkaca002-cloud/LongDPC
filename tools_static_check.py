...
ok("versionCode 13" in app_gradle, 'versionCode must be 13')
ok("versionName '2.2-split-fix-email-list-apn'" in app_gradle, 'versionName mismatch')
...
ok('apps-v2/gmail.apks' in catalog, 'default Gmail APKS URL missing')
ok('apps-v2/long-ocr.apk' in catalog, 'default Long OCR APK URL missing')
...
ok("versionName '1.2-quality-capture'" in (root/'longocr/build.gradle').read_text(), 'Long OCR version mismatch')
...
print('Version: 2.2-split-fix-email-list-apn (13)')
